...
function discoveryFocus() {
  const slices = [
    ...
    'Southern Nevada entertainment buyers, hospitality groups, agencies and promoters who place musicians into multiple Las Vegas or Laughlin rooms.'
  ];
  const now = new Date();
